...
CEILING_PUREV2_DIR = Path("local_descriptors/routerbench-ceiling")  # already full-data, no rebuild needed
...
def main():
    ...
    out_path = Path("local_descriptors/routerbench-analysis/purev2_ablation3way_allseen_results.json")
    json.dump(all_results, open(out_path, "w"), indent=2)

    print("\n" + "=" * 90)
    print("ROUTERBENCH PURE V2 -- 3-WAY ABLATION SUMMARY (all-seen)")
    print("=" * 90)
