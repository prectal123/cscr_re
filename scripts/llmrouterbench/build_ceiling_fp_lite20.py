"""Ceiling FP (528-dim) for the lightweight-20 pool, mean-centered + L2-normalized."""
import json
import pickle
...
def main():
    ...
    print(f"Ceiling FP lite20: shape={E.shape}  pairwise cosine sim: mean={off.mean():.4f} std={off.std():.4f} "
