...
CEILING_DIR = Path("local_descriptors/llmrouterbench_v15_900/perplexity")  # CSCR own FP (dim=192), COMPAR loss applied
...
def main():
    ...
    out_path = Path("local_descriptors/llmrouterbench_v15_900") / "cscrfp_comparloss_allseen_unseen_results.json"
    json.dump(results, open(out_path, "w"), indent=2)

    print("\n" + "=" * 90)
    print("LLMROUTERBENCH CSCR FP (Perplexity, dim=192) + COMPAR LOSS")
    print("=" * 90)
