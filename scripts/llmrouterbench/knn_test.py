"""Step 2: training-free kNN unseen-recovery test for the LLMRouterBench
33-model pool -- ports routerbench_knn_test.py's method exactly (FP-weighted
proxy vs uniform-average proxy, Spearman rho against true Set B scores,
paired t-test across the 33 LOO folds), for both Ceiling and Perplexity FP,
plus a direct Ceiling-vs-Perplexity paired comparison (this session's
strongest/most trusted RouterBench result used this same design).
"""
import sys
