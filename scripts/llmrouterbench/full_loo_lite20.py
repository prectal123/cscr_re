"""Full 20-fold LOO (every model held out once), both Ceiling and Perplexity
FP, beta=1.0, seed=0. Lightweight-20 pool, 22-dataset version.
"""
import json
import random
import sys
...
SEED = 0
BETA = 1.0
OUT_PATH = Path("local_descriptors/llmrouterbench_lite20/full_loo_results.json")
